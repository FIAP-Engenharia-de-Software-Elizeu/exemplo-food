...
const Pedido = () => {
    ...
    const alterarQuantidade = (id, valor) => {
        ...
        setItems(prev =>
        //MAP: percorre a lista para criar um NOVO array sem modificar o
        //original(IMUTABILIDADE)
            prev.map(item =>

                //TERNARIO: Verifica se o item da iteração atual é o que deve ser alterado 
                //SPREED (...item):copia as propriedades do item e atualiza apenas a quantidade mantendo resto
                //Math.max : Garante que a quantidade nunca seja menor que 0
                //Item: retorna o item intacto caso o id não corrresponda
